    ...
    try:
        ...
        if result.returncode == 0 and result.stdout.strip():
            ...
            if num_gpus > 0:
                ...
                return f"{num_gpus}x {name} (Compute {cap})", "CUDA"
